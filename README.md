# [SOLVED] Error-Quot-Filename-Whl-Is-Not-A-Supported-Wheel-On-This-Pla
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/error-quot-filename-whl-is-not-a-supported-wheel-on-this-pla)
>
...
Try installing scipy using pip by specifying the full path to the wheel file, or upgrade pip to a newer version that supports the wheel format.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/error-quot-filename-whl-is-not-a-supported-wheel-on-this-pla)**
